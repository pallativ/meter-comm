...
public class InstantData implements java.io.Serializable {
	...
	public String toString() {
		...
		try {
			...
			/**01*/strb.append(id.getMeterSerialNumber()+",");//METER SERIAL NUMBER
			/**02*/strb.append(id.getInstantDatetime()+",");//DATE TIME
			/**03*/strb.append(sumImportActiveEnergy+",");//sumImportActiveEnergy
			/**04*/strb.append(sumExportActiveEnergy+",");//sumExportActiveEnergy
			/**05*/strb.append(activeEnergyCombinedTotal+",");//activeEnergyCombinedTotal
			/**06*/strb.append(activeEnergyNetTotal+",");//activeEnergyNetTotal
			/**07*/strb.append(apparentEnergyImport+",");//apparentEnergyImport
			/**08*/strb.append(apparentEnergyExport+",");//apparentEnergyExport
			/**09*/strb.append(voltageL1+",");//voltageL1
			/**10*/strb.append(voltageL2+",");//voltageL2
			/**11*/strb.append(voltageL3+",");//voltageL3
			/**12*/strb.append(currentL1+",");//currentL1
			/**13*/strb.append(currentL2+",");//currentL2
			/**14*/strb.append(currentL3+",");//currentL3
			/**15*/strb.append(netFrequency+",");//netFrequency
			/**16*/strb.append(activeImportPower+",");//activeImportPower
			/**17*/strb.append(activeExportPower+",");//activeExportPower
			/**18*/strb.append(reactiveImportPower+",");//reactiveImportPower
			/**19*/strb.append(reactiveExportPower+",");//reactiveExportPower
			/**20*/strb.append(apparentImportPower+",");//apparentImportPower
			/**21*/strb.append(apparentExportPower+",");//apparentExportPower
			/**22*/strb.append(powerFactorL1+",");//powerFactorL1
			/**24*/strb.append(powerFactorL2+",");//powerFactorL2
			/**25*/strb.append(powerFactorL3+",");//powerFactorL3
			/**26*/strb.append(phaseAngleL1+",");//phaseAngleL1
			/**27*/strb.append(phaseAngleL2+",");//phaseAngleL2
			/**28*/strb.append(phaseAngleL3+",");//phaseAngleL3
