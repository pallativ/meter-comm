...
public class BillingHistory {
    ...
    public String toString() {
        return "BillingHistory{" + "id=" + id + ", meterNumber=" + meterNumber + ", billingMonth=" + billingMonth + ", updatedAt=" + updatedAt + ", activeEnergyImport=" + activeEnergyImport + ", activeEnergyExport=" + activeEnergyExport + ", activeEnergyCombinedTotal=" + activeEnergyCombinedTotal + ", activeEnergyNetTotal=" + activeEnergyNetTotal + ", activeEnergyImportT1=" + activeEnergyImportT1 + ", activeEnergyImportT2=" + activeEnergyImportT2 + ", activeEnergyImportT3=" + activeEnergyImportT3 + ", activeEnergyImportT4=" + activeEnergyImportT4 + ", activeEnergyExportT1=" + activeEnergyExportT1 + ", activeEnergyExportT2=" + activeEnergyExportT2 + ", activeEnergyExportT3=" + activeEnergyExportT3 + ", activeEnergyExportT4=" + activeEnergyExportT4 + ", apparentEnergyImport=" + apparentEnergyImport + ", apparentEnergyExport=" + apparentEnergyExport + ", apparentEnergyImportT1=" + apparentEnergyImportT1 + ", apparentEnergyImportT2=" + apparentEnergyImportT2 + ", apparentEnergyImportT3=" + apparentEnergyImportT3 + ", apparentEnergyImportT4=" + apparentEnergyImportT4 + ", apparentEnergyExportT1=" + apparentEnergyExportT1 + ", apparentEnergyExportT2=" + apparentEnergyExportT2 + ", apparentEnergyExportT3=" + apparentEnergyExportT3 + ", apparentEnergyExportT4=" + apparentEnergyExportT4 + ", activeEnergyCombinedTotalT1=" + activeEnergyCombinedTotalT1 + ", activeEnergyCombinedTotalT2=" + activeEnergyCombinedTotalT2 + ", activeEnergyCombinedTotalT3=" + activeEnergyCombinedTotalT3 + ", activeEnergyCombinedTotalT4=" + activeEnergyCombinedTotalT4 + ", activeEnergyNetTotalT1=" + activeEnergyNetTotalT1 + ", activeEnergyNetTotalT2=" + activeEnergyNetTotalT2 + ", activeEnergyNetTotalT3=" + activeEnergyNetTotalT3 + ", activeEnergyNetTotalT4=" + activeEnergyNetTotalT4 + ", maxActivePowerImport=" + maxActivePowerImport + ", maxActivePowerImportAt=" + maxActivePowerImportAt + ", maxActivePowerExport=" + maxActivePowerExport + ", maxActivePowerExportAt=" + maxActivePowerExportAt + ", maxApparentPowerImport=" + maxApparentPowerImport + ", maxApparentPowerImportAt=" + maxApparentPowerImportAt + ", maxApparentPowerExport=" + maxApparentPowerExport + ", maxApparentPowerExportAt=" + maxApparentPowerExportAt + '}';
    }
