			...
			for (String str : dataList) {
				...
				try {
					...
					for (Integer i = 0; i < strArr.length; i++) {
						...
						} else if (obisCode.equalsIgnoreCase("01 00 0F 08 00 FF")) {// Active energy (|+A|+|-A|)
																					// Combined total
							instantData.setActiveEnergyCombinedTotal(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 10 08 00 FF")) {// Active energy (|+A|-|-A|) Net
																					// total
							instantData.setActiveEnergyNetTotal(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 09 08 00 FF")) {// Apparent energy import (+VA)
																					// (QI+QIV)
							instantData.setApparentEnergyImport(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 0A 08 00 FF")) {// Apparent energy export (-VA)
																					// (QII+QIII)
						...
						} else if (obisCode.equalsIgnoreCase("01 00 01 07 00 FF")) {// Instantaneous active import power
																					// (+A)
							instantData.setActiveImportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 02 07 00 FF")) {// Instantaneous active export power
																					// (-A)
							instantData.setActiveExportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 03 07 00 FF")) {// Instantaneous reactive import
																					// power (+R))
							instantData.setReactiveImportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 04 07 00 FF")) {// Instantaneous reactive export
																					// power (+R))
							instantData.setReactiveExportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 09 07 00 FF")) {// Instantaneous apparent import
																					// power (+VA)
							instantData.setApparentImportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 09 07 00 FF")) {// Instantaneous apparent Export
																					// power (+VA)
							instantData.setApparentExportPower(Double.parseDouble(dataVal));
						} else if (obisCode.equalsIgnoreCase("01 00 0A 07 00 FF")) {// Instantaneous apparent Export
																					// power (+VA)
							instantData.setApparentExportPower(Double.parseDouble(dataVal));
